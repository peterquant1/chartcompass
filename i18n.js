...
window.CC_I18N = {
    en: {
        ...
        how: {
            ...
            s1b: "One payment, instant access. No hidden fees.",
        ...
        pricing: {
            ...
            cta: "Get ChartCompass",
            note: "Secure crypto checkout via OxaPay · BTC / ETH / USDT and more · Instant delivery",
        },
        faq: {
            kicker: "FAQ",
            title: "Questions?",
            ...
            a2: "As soon as your payment is confirmed you'll receive access and simple setup instructions. Adding it to TradingView takes under a minute — no technical skill needed.",
            ...
            a5: "Because you receive the full indicator immediately after payment, all sales are final — this protects every trader in our community. Watch the demo above to see exactly what you'll get on your chart.",
    ...
    zh: {
        ...
        pricing: {
            ...
            cta: "获取 ChartCompass",
            note: "通过 OxaPay 加密支付安全结算 · 支持 BTC / ETH / USDT 等 · 即时交付",
        },
        faq: {
            kicker: "常见问题",
            title: "有问题吗？",
            ...
            q2: "购买后如何获得访问权限？",
            a2: "付款确认后，你将立即收到访问权限和简单的设置说明。添加到 TradingView 不到一分钟，不需要技术背景。",
            q3: "我是新手，能看懂吗？",
            a3: "可以。指标给出清晰的买卖信号和颜色区域，另外配有视频教程、说明文档和交流社群，随时可以提问。",
            q4: "我能获得什么样的支持？",
            a4: "私密交流社群、直接的邮件支持、视频教程和完整说明文档。",
            q5: "有免费试用吗？",
            a5: "由于付款后你会立即收到完整指标，所有销售均为最终销售 — 这是为了保护社群里的每一位交易者。可以先观看上方的演示，看看你的图表上会得到什么。",
            q6: "是订阅制吗？",
